...
CREATE TABLE `coin_history` (
  ...
  `source` enum('IN_INAPP','IN_RIDI','IN_EVENT','IN_PART_REFUND','OUT_BUY_PART','OUT_COIN_REFUND','OUT_WITHDRAW') NOT NULL COMMENT 'IN_INAPP: 인앱결제, IN_RIDI: 리디캐시 결제, IN_EVENT: 이벤트용 코인, IN_PART_REFUND: 구매한 파트 환불, OUT_BUY_PART: 코인사용(파트 구매), OUT_COIN_REFUND: 환불, OUT_WITHDRAW: 회수(취소)',
