...
require_once 'controllers/admin/coin_product.php';
...
require_once 'controllers/admin/push_notification.php';
...
$app->mount('/admin/coin_product', new AdminCoinProductControllerProvider());
...
$app->mount('/admin/push', new AdminPushNotificationControllerProvider());
