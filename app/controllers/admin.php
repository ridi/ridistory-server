...
select A.title, interested_d6, interested_d5, interested_d4, interested_d3, interested_d2, interested_d1, interested_d0,
  (interested_d6 + interested_d5 + interested_d4 + interested_d3 + interested_d2 + interested_d1 + interested_d0) as interested_sum,
  interested_total from book A
    ...
    join (select b_id, count(b_id) interested_total from user_interest group by b_id) TOTAL on A.id = TOTAL.b_id
order by title
EOT;
